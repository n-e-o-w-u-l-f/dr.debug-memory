...
|---|---|---|---|---|---|
| Repository manifests | `MANIFEST.json`, `MANIFEST_BATCH5.json`, `MANIFEST_BATCH6.json`, `SHA256SUMS.txt` | ARTIFACT_MANIFEST | INTERNAL_REPO_METADATA | REPORT_ONLY | Navigation/checksum metadata. Do not treat as factual canonical Memory content by itself. |
| Batch readme packages | `README_IMPORTANT.md`, `README_IMPORTANT_BATCH5.md`, `README_IMPORTANT_BATCH6.md`, `README_IMPORTANT_BATCH7.md`, `README_IMPORTANT_BATCH8.md`, `README_IMPORTANT_BATCH9.md` | BATCH_README_OR_HANDOFF | INTERNAL_REPO_METADATA | PROPOSAL_CONTEXT | Batch documentation and handoff summaries. Keep as context, not second truth. |
| Research source notes | `SOURCES_RESEARCHED_BATCH4.md` through available batch source notes | SOURCE_RESEARCH_NOTES | MIXED_SOURCE_NOTES | NEEDS_SOURCE_REGISTRY_REVIEW | Useful for provenance. Individual claims still require source-record normalization before canonical use. |
