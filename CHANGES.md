...
- Product-specific download URLs were not verified for every ASUS model; the ASUS generic ASUS Download Center is stored as fallback lookup URL where needed.
...
- Imported 6 verified manufacturer records for the initial mainboard / bios_uefi metadata round.
